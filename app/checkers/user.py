...
def register_params_check(content):
    ...
    try:
        ...
        if username_len < 5 or username_len > 12 or not re.match(username_pattern, username):
            return "username", False
    ...
    try:
        ...
        password_pattern = re.compile(r"^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[-_*^]).{8,15}$", re.S)
    ...
    try:
        ...
        if not isinstance(url, str):
            return 'url', False
        url_pattern = re.compile(r"^(https?:\/\/)(((([\da-zA-Z]+)|([\da-zA-Z][\da-zA-Z-]*[\da-zA-Z]))\.)+(([\da-zA-Z]+)|([\da-zA-Z][\da-zA-Z-]*[\da-zA-Z])))$", re.S)
        if not re.match(url_pattern, url):
            return "url", False
        else:
            re_body = re.compile(r"(((([\da-zA-Z]+)|([\da-zA-Z][\da-zA-Z-]*[\da-zA-Z]))\.)+(([\da-zA-Z]+)|([\da-zA-Z][\da-zA-Z-]*[\da-zA-Z])))$", re.S)
